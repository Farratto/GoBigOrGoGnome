...
--luacheck: globals getCreatureSizeDnD3Original getCreatureSizeDnD5Original getSpaceReachOriginal
...
--luacheck: globals fgetNPCSpaceReach getNPCSpaceReachPFRPG2SM
--luacheck: globals fgetNPCSpaceReach getNPCSpaceReachADNDSM
...
function onInit()
	...
	if CombatRecordManagerADND and CombatRecordManagerADND.getNPCSpaceReach then
		DataCommon.creaturesize['giant'] = 4.5;
		DataCommon.creaturesize['colossal'] = 7;
		DataCommon.creaturesize['c'] = 7;
...
function getNPCSpaceReachPFRPG2SM(rActor)
	...
	local nActorSize = ActorManager2.getSize(nodeNPC);
	...
	local sMeleeAttacks = DB.getValue(nodeNPC, "meleeatk", "");
